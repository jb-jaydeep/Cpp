...
//Create movie ticket booking system using 
//constructor : to welcome the user
//setter with switch case to take user choice of language, movie name and number of tickets
...
class Booking {
	...
	Booking(){
		...
		cout << "====================================================================="<<endl;
		cout << "\t\t WELCOME TO THE INOX CINEMA..."<<endl
		     << "====================================================================="<<endl;
	}
		...
		cout << "\t\tFor any Query Contact us on 9099339099" << endl;
		cout << "====================================================================="<<endl;
	}
};
